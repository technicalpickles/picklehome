...
Registry of each service running on the homelab.

## Deployment pattern

All services follow the same pattern. Deploy from Mac:
...
TLS and external access use **Tailscale Services**: `tailscaled` on the host terminates HTTPS and proxies to the local container port. No reverse proxy container needed.
...
See [services/vikunja/README.md](../services/vikunja/README.md) for full setup.
...
See [services/backup/README.md](../services/backup/README.md) for what's captured and restore procedure.
...
See [services/brineworks-server/README.md](../services/brineworks-server/README.md) for full setup.
